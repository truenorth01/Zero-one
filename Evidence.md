...
1. **Claim** — Measurable automated post-training and harness-evolution loops exist as early demos; calibrated economics argues current feedback loops are not yet self-sustaining; they are not open-ended frontier recursive self-improvement.
2. **Best source** — NeoHorse-1 (arXiv:2609.08183) ([68](Sources.md#ref-68)); A-Evolve (arXiv:2606.20657) ([69](Sources.md#ref-69)); ModularRSI (arXiv:2609.14857) ([72](Sources.md#ref-72)); Cunningham et al. economics of RSI (arXiv:2609.15802) ([71](Sources.md#ref-71)); Artificial Analysis Index v4.3 labeled company snapshot ([70](Sources.md#ref-70)).
3. **What it actually shows** — NeoHorse: macro-average gains on 4B/9B models across eleven benchmarks (~59→65, ~66→69) via evaluation→selection→training harness. A-Evolve: autonomous four-round post-training of a 30B model, including revising its own search policy; competition held-out near top human. ModularRSI: benchmark-disjoint modular harness evolution with Acc ~61.8→67.4 on TerminalBench 2.0 and ~73.4→76.5 on SWE-Bench Verified under a unified Harbor protocol, with cross-model transfer of the frozen harness. RSI economics: net acceleration depends on the product of elasticities across feedback loops; a back-of-envelope calibration finds loops not currently strong enough for self-sustaining acceleration (though strengthening). AA Index: dated third-party capability snapshot (tied leads near 53).
4. **What it does not show** — Open-ended RSI of frontier weights in the wild; autonomous R&D that safely generalizes beyond competition or small/mid-model / harness loops with external corrigibility preserved; takeoff timing.
5. **Label** — **C** (early demos + calibrated “not yet self-sustaining” estimate); **S** (unconstrained takeoff / frontier RSI).
